...
export default function SectionProducts() {
  ...
  return (
    <section className="section sectionProducts min-h-screen bg-zinc-200 flex items-center justify-center py-20 md:py-40">
      <div className="container mx-auto grid grid-cols-1 gap-10 md:gap-15 place-items-start px-5 md:px-0">
        ...
        <div className="grid grid-cols-1 gap-2 text-2xl col-span-1">
          ...
          <div className="text-lg md:text-xl">Innovative Membrane Solutions</div>
