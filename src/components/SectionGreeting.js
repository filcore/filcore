...
export default function SectionGreeting() {
  return (
    <section className="section sectionGreeting min-h-screen bg-zinc-100 flex items-center justify-center bg-[url(/white1.jpg)] bg-cover bg-center py-20 md:py-40">
